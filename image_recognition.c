...
/*	全域變數
	...
	IR_run 1/0 是否執行影像辨識執行緒
	IR_humanIdentification 1/0 是否正在執行人型辨識(不要了)
	IR_judgment 1/0 是否有跌倒
*/
                    ...
                    double scale, bool tryflip )
{
    int i = 0;
    double t = 0;
    int count1=0;//fitst circle head
    int count3=0;//circle head
	...
	{
		count2 = count1;
		//printf("someone in camera\n");
		count1 = 0;
	}
	else if(count1 ==0 && count2 ==0)
	{
		//printf("nobody in camera\n");
		count2 = count1;
