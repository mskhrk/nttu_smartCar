//car_main3.c
//gcc -o car_main3 car_main3.c sm_car.c uart_setting.c treatWifi.c accident_decection.c carMove.c -lpthread -lrt
/*common library*/
#include <stdio.h>
#include <stdlib.h>
...
//ret5 = pthread_create(&thread5,NULL,threadFun5, (void*) msg5);
