...
//規劃下一步走的點
//goDirection1 目標絕對方向無=0 北=1 南=3
//goDirection2 目標絕對方向無=0 東=2 西=4
//第二路徑起點secendPoint
//前一點previousPoint
//備援點secPoint
{
...
int use_map(int map_x,int map_y,int *vector)
{
	//分析直線方向是否可以直走
	if(vector[2]>100&&vector[3]>100&&vector[4]>100)
	{
		//呼叫移動控制走60cm
	}
